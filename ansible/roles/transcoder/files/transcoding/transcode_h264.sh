...
ffmpeg -y -hide_banner\
  ...
  \
  -c:v libx264 -r 25 -g 50 -x264opts keyint=50:scenecut=-1 \
  -map v:0 -s:v:0 1920x1080 -bufsize:v:0 4.0M -b:v:0 3.5M -maxrate:v:0 4.0M -crf:v:0 21 \
  -map v:0 -s:v:1 1280x720 -bufsize:v:1 2.0M -b:v:1 1.8M -maxrate:v:1 2.0M -crf:v:1 21 \
  -map v:0 -s:v:2 960x540 -bufsize:v:2 1.5M -b:v:2 1.35M -maxrate:v:2 1.5M -crf:v:2 21 \
  -map v:0 -s:v:3 640x360 -bufsize:v:3 1M -b:v:3 0.9M -maxrate:v:3 1M -crf:v:3 21 \
  -map v:0 -s:v:4 320x180 -bufsize:v:4 0.5M -b:v:4 0.45M -maxrate:v:4 0.5M -crf:v:4 21 \
  \
