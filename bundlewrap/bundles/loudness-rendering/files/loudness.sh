...
/usr/local/sbin/voc2alert "info" "loudness" "Loudness monitoring for ${stream_name} started ..."
...
ffmpeg \
    ...
    -f flv \
    "rtmp://ingest2.c3voc.de/relay/${stream_name}_loudness"

/usr/local/sbin/voc2alert "info" "loudness" "Loudness monitoring for ${stream_name} stopped, ffmpeg exit code $?."
